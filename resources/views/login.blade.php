  ...
  <div class="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1 justify-center items-center">
            ...
            @if (session('show_register_link'))
                <div class="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded mb-4 w-full">
                    ...
                    <a href="{{ session('register_url') }}" class="font-medium text-blue-600 hover:underline">Regístrate aquí</a>
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-4 px-4 py-3 w-full items-center">
              ...
              <input
                ...
                value="{{ old('email') }}"
                class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0d141c] focus:outline-0 focus:ring-0 border border-[#cedbe8] bg-slate-50 focus:border-[#cedbe8] h-14 placeholder:text-[#49739c] p-[15px] text-base font-normal leading-normal @error('email') border-red-500 @enderror"
                required
              />
              <input
                type="password"
                ...
                class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-[#0d141c] focus:outline-0 focus:ring-0 border border-[#cedbe8] bg-slate-50 focus:border-[#cedbe8] h-14 placeholder:text-[#49739c] p-[15px] text-base font-normal leading-normal @error('password') border-red-500 @enderror"
                required
              />
