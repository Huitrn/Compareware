        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e7edf4] px-10 py-3">
          <div class="flex items-center gap-8">
            ...
            <div class="flex items-center gap-9">
              ...
              <a class="text-[#0d141c] text-sm font-medium leading-normal" href="#">Comparar</a>
              <a class="text-[#0d141c] text-sm font-medium leading-normal" href="#">Periféricos</a>
              <a class="text-[#0d141c] text-sm font-medium leading-normal" href="#">Comunidad</a>
            </div>
          </div>
